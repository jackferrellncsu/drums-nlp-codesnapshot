...
nonconf_dist = histogram(α_i, bins = 0:.022:1, color = :red, leg = false,
...
close_nonconf_dist = histogram(ranger, bins = 0:8.547008547008547e-7:.0002,
                                color = :red, leg = false, grid = false,
...
emp_prop = plot(confs, nominal, leg = false, grid = false)
emp_prop = plot!(confs, confs)
...
set_sizes999 = histogram(sizes_999, leg = false, bins = 141, color = :red, grid = false,
